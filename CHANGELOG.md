...
- Show an animated Chinese/English status bubble at the caret on mode changes and input-source activation, with automatic dismissal and support for reduced motion.
