...
- Use a white-backed logo with more pronounced rounded corners in the macOS input-source switcher and menu bar; preserve the original logo in Cassotis's Chinese/English status bubble.
